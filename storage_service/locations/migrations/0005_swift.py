...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Swift'
        db.create_table(u'locations_swift', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('space', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['locations.Space'], to_field='uuid', unique=True)),
            ('auth_url', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('auth_version', self.gf('django.db.models.fields.CharField')(default='2', max_length=8)),
            ...
            ('container', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('tenant', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        db.send_create_signal('locations', ['Swift'])


    def backwards(self, orm):
        # Deleting model 'Swift'
        db.delete_table(u'locations_swift')
    ...
    models = {
        ...
        'locations.package': {
            ...
            'origin_pipeline': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Pipeline']", 'to_field': "'uuid'"}),
        ...
        'locations.swift': {
            'Meta': {'object_name': 'Swift'},
            'auth_url': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'auth_version': ('django.db.models.fields.CharField', [], {'default': "'2'", 'max_length': '8'}),
            'container': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'space': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['locations.Space']", 'to_field': "'uuid'", 'unique': 'True'}),
            'tenant': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
